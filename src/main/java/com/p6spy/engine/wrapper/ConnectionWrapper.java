...
public class ConnectionWrapper extends AbstractWrapper implements Connection {
  ...
  public Statement createStatement() throws SQLException {
    System.out.println("sssss:"+delegate.getClass().getName());
  ...
  public PreparedStatement prepareStatement(String sql) throws SQLException {
    ...
    // 解决ResultSet更新操作时产生错误
    // return PreparedStatementWrapper.wrap(delegate.prepareStatement(sql, ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_UPDATABLE), new PreparedStatementInformation(connectionInformation, sql), jdbcEventListener);
  }
